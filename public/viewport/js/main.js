...
const pageSlider = e => {
      let i = e.element || "",
         ...
         l = $(i).slick({
            ...
            prevArrow: '<div class="slick-prev"><img src="https://ahknoxo.com/viewport/img/bytesize_arrow-right.png"></div>',
            nextArrow: '<div class="slick-next"><img src="https://ahknoxo.com/viewport/img/arrow-right.png"></div>',
            responsive: t
         });
      if (s) {
