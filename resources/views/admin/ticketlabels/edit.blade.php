...
@section('admin_content_header')
	<div class="col-sm-6">
		<h1 class="m-0">Update Ticket Label</h1>
	</div><!-- /.col -->
	@php 
	  $list = json_encode(['Home', 'Ticket Label']);
	@endphp
...
@section('admin_main_content')
	...
	<div class="container-fluid">
    	<form action="{{route('ticket-labels.update',$data->id)}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
    		@csrf
    		@method('put')
        	<div class="row">
	          	...
	          	<div class="col-md-12 col-sm-12">
		            ...
		            <div class="card card-default">
		                ...
		                <div class="card-footer">
		                  	...
		                  	<a href="{{route('ticket-labels.index')}}" class="btn btn-default float-right">Cancel</a>
		                </div>
		                <!-- /.card-footer -->
		            </div>
		            <!-- /.card -->
