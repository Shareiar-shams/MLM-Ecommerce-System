		...
		<div class="card">
			<div class="card-header">
				<div class="card-title">
					<h5 class="m-0">Add Affiliate Product</h5>
				</div>
		            ...
		            <div class="card card-default">
		                ...
		                <div class="card-body">
			                ...
			                <div class="form-group">
			                    ...
			                    <input type="text"  class="form-control" id="affiliate_link" name="affiliate_link" placeholder="Affiliate Link" required>
			                </div>
			                ...
			                <input type="hidden" name="productType" value="affiliate">
		                </div>
		                <!-- /.card-body -->
		            </div>
		            <!-- /.card -->
