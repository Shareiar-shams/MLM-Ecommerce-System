		            ...
		            <div class="card card-default">
		                ...
		                <div class="card-body">
			                ...
			                <div class="form-group">
			                    ...
			                    <input type="text"  class="form-control" id="affiliate_link" name="affiliate_link" value="{{$product->affiliate_link}}" placeholder="Affiliate Link" required>
			                </div>
			                ...
			                <div class="form-group">
			                    ...
			                    <div class="input-group">
				                    <div class="custom-file">
				                        <input type="file" value="{{$product->featured_image}}" accept="image/*" onchange="loadFile(event)" name="featured_image" class="custom-file-input" id="FeaturedImageInputFile" required>
