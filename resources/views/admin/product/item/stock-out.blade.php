...
@section('admin_content_header')
	<div class="col-sm-6">
		<h1 class="m-0">Stock Out Products List</h1>
	</div><!-- /.col -->
	@php 
		                ...
		                <table id="example1" class="table table-bordered table-striped">
		                  	...
		                  	<tbody>
			                  		@foreach($products as $data)
						                <tr>
					                    	<td>{{$loop->index + 1}}</td>
					                    	<td><img class="img-responsive" width="50" height="70" src="{{Storage::disk('local')->url($data->featured_image)}}" alt="Product Image {{$data->id}}"></td>
					                    	<td>{{$data->name}}</td>
					                    	...
					                    	<td>
					                    		<div class="btn-group">
								                    ...
								                    <div class="dropdown-menu" role="menu">
								                    	<form action="{{route('type.status',$data->id)}}" method="post" id="disable-form-{{$data->id}}" style="display: none;">
					                              			@csrf
					                              			@method('put')
					                    	...
					                    	<td>{{$data->productType == 'physical' ? "Normal" : "Affiliate"}}</td>
					                    	{{-- <td>
					                    	...
					                    	<td>
					                    		<div class="btn-group">
								                    ...
								                    <div class="dropdown-menu" role="menu">
								                    		...
								                    		<a class="dropdown-item" href="{{route('item.show',$data->id)}}"><i class="fas fa-angle-double-right"></i>View</a>
