...
@section('admin_title_content')
    AHVision | Create Customize Option
@endsection
...
@section('admin_content_header')
	<div class="col-sm-6">
		<h1 class="m-0">Create Customize Option</h1>
	</div><!-- /.col -->
	@php 
...
@section('admin_main_content')
	...
	<div class="container-fluid">
    	...
    	<form action="{{route('product.customize.design.store',$product->id)}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
    		@csrf
        	<div class="row">
		            ...
		            <div class="card card-default">
		                ...
		                <div class="card-body">
			                <div class="form-group">
			                    ...
			                    <input type="text"  class="form-control" onkeyup="listingslug(this.value)" id="name" name="option_name" placeholder="Enter Name" required>
			                </div>
			                <div class="form-group">
			                    <label for="exampleInputPassword1">Option Value *</label>
			                    <input type="text" class="form-control" id="slug" name="option_value" placeholder="Enter Value" required>
			                </div>
			                <div class="form-group">
			                    <label for="exampleInputEmail1">Option Type *</label>
			                    <input type="text"  class="form-control" id="type" name="option_type" placeholder="Enter Type" required>
			                </div>
