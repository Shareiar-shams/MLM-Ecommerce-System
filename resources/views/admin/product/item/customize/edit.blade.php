		...
		<div class="card">
			<div class="card-header">
				<div class="card-title">
					<h5 class="m-0">Update Customize Product</h5>
				</div>
	          	...
	          	<div class="col-md-8 col-sm-6">
		            ...
		            <div class="card card-default">
			            ...
			            <div class="card-body">
			            	...
			            	<div class="from-group">
				            	<label for="exampleInputEmail1">External Customize Charge Info</label>
				            	<input type="text" name="customize_charge" class="form-control" placeholder="Enter Customize Charge" value="{{$product->customize_charge}}">
			            	</div>
