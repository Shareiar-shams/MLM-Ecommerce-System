            	...
            	<div class="card">
	              	<div class="card-header">
	                	...
	                	<div class="right-content" style="float: right;">
		                	<a href="{{route('product.attribute.option',$id)}}" class="btn btn-primary" title=""><i class="fas fa-chevron-left"></i>Back</a>
	                	</div>
	              	</div>
	            </div>
	        </div>
		</div>
    	<form action="{{route('product.attribute.option.store',$id)}}" method="post" >
    		@csrf
        	<div class="row">
