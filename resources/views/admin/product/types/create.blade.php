...
@section('admin_content_header')
    <div class="col-sm-6">
        <h1 class="m-0">{{___('Product Tags Create')}}</h1>
    </div><!-- /.col -->
    <!-- breadcrumb -->
	          	...
	          	<div class="col-md-12 col-sm-12">
		            ...
		            <div class="card card-default">
		                ...
		                <div class="card-body">
							<div class="form-group">
								<input type="text" name="name" class="form-control" value="{{ old('name') }}" onkeyup="listingslug(this.value)" id="name" placeholder="Tags Name" required>
							</div>
							<div class="form-group">
		            ...
		            <div class="card card-default">
		                ...
		                <div class="card-footer">
		                  	...
		                  	<a href="{{route('admin.product.type.index')}}" class="btn btn-default float-right">Cancel</a>
		                </div>
		                <!-- /.card-footer -->
		            </div>
		            <!-- /.card -->
