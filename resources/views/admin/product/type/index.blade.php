...
@section('admin_content_header')
	<div class="col-sm-6">
		<h1 class="m-0">Product Type List</h1>
	</div><!-- /.col -->
	@php 
          	...
          	<div class="col-12">
            	...
            	<div class="card">
	              	<div class="card-header">
	                	...
	                	<a href="{{route('type.create')}}" class="btn btn-primary" style="float: right;" title="">Add Type</a>
	              	</div>
		            <!-- /.card-header -->
		            <div class="card-body">
				                ...
				                <tr>
			                    	...
			                    	<td>
			                    		<div class="btn-group">
						                    ...
						                    <div class="dropdown-menu" role="menu">
						                    	<a class="dropdown-item" href="{{route('type.edit',$data->id)}}"><i class="fas fa-angle-double-right"></i>Edit</a>
						                    	...
						                    	<form action="{{route('type.destroy',$data->id)}}" method="post" id="delete-form-{{$data->id}}" style="display: none;">
						                      		@csrf
											        @method('delete')
					                            </form>
