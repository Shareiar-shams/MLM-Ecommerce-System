...
@section('admin_main_content')
	...
	<div class="container-fluid">
    	...
    	<form action="{{route('code.store')}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
    		@csrf
        	<div class="row">
		                ...
		                <div class="card-body">
			                ...
			                <div class="from-group">
				            	<label for="exampleInputEmail1">Number of Times *</label>
				              	<input type="text"  class="form-control" id="number_of_times" name="number_of_times" placeholder="Enter Number Of Times" required>
				            </div>
					        </br>
				            <div class="form-group">
                                ...
                                <div class="input-group input-group-lg mb-3">
                                    ...
                                    <input type="number" style="height: 60px;" id="discount" name="discount" class="form-control" placeholder="Enter Discount" min="0" step="0.1">
                                </div>
                            </div>
