	        ...
	        <div class="col-12">
	          	...
	          	<div class="card">
	              	<div class="card-header">
	                	...
	                	<a href="{{route('admins.create')}}" class="btn btn-primary" style="float: right;" title=""><i class="fas fa-plus"></i>Add</a>
	              	</div>
		            <!-- /.card-header -->
		            <div class="card-body">
				                    	...
				                    	<td>
				                    		<div class="btn-group">
							                    ...
							                    <div class="dropdown-menu" role="menu">
							                    	<a class="dropdown-item" href="{{route('admins.edit',$admin->id)}}"><i class="fas fa-angle-double-right"></i>Edit</a>
							                    	...
							                    	<form action="{{route('admins.destroy',$admin->id)}}" method="post" id="delete-form-{{$admin->id}}" style="display: none;">
							                      		@csrf
														@method('delete')
						                        	</form>
							                    </div>
