	                  	...
	                  	<div class="direct-chat-messages" style="height: 100%">
		                	@foreach($messages as $message)
			                    ...
			                    <div class="direct-chat-msg @if($message->sender_type == 'admin') right @endif">
				                    ...
				                    @else
				                    	<img class="direct-chat-img" src="{{asset('admin/dist/img/noimage.jpg')}}" alt="message user image">
				                    @endif
				                    <!-- /.direct-chat-img -->
	                ...
	                <div class="card-footer">
		                <form action="{{route('userchat.store')}}" method="post">
		                    ...
		                    <div class="input-group">
		                      ...
		                      <input type="hidden" name="receiver_id" value={{$mlmuser->user->id}} class="form-control" id="receiverIdInput">
