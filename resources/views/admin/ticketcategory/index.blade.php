...
@section('admin_title_content')
    AHVision | Tickets Categories List
@endsection
...
@section('admin_content_header')
	<div class="col-sm-6">
		<h1 class="m-0">Tickets Categories List</h1>
	</div><!-- /.col -->
	@php 
	  $list = json_encode(['Home', 'Categories List']);
	@endphp
          	...
          	<div class="col-12">
            	...
            	<div class="card">
	              	<div class="card-header">
	                	...
	                	<a href="{{route('ticket-categories.create')}}" class="btn btn-primary" style="float: right;" title="">Add Category</a>
	              	</div>
		            <!-- /.card-header -->
		            <div class="card-body">
			                    	...
			                    	<td>
			                    		<div class="btn-group">
						                    ...
						                    <div class="dropdown-menu" role="menu">
						                    	<form action="{{route('ticket-categories.status',$data->id)}}" method="post" id="disable-form-{{$data->id}}" style="display: none;">
			                              			@csrf
			                              			@method('put')
			                    	...
			                    	<td>
			                    		<div class="btn-group">
						                    ...
						                    <div class="dropdown-menu" role="menu">
						                    	...
						                    	<form action="{{route('ticket-categories.destroy',$data->id)}}" method="post" id="delete-form-{{$data->id}}" style="display: none;">
						                      		@csrf
											        @method('delete')
					                            </form>
