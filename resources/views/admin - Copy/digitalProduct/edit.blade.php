...
@section('admin_content_header')
	<div class="col-sm-6">
		<h1 class="m-0">Update Digital Product</h1>
	</div><!-- /.col -->
	@php 
...
@section('admin_main_content')
	...
	<div class="container-fluid">
    	<form action="{{route('digitalproduct.update',$data->id)}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
    		@csrf
    		@method('put')
        	<div class="row">
	          	...
	          	<div class="col-md-8 col-sm-6">
		            ...
		            <div class="card card-default">
				        ...
				        <!-- /.card-header -->
		                <div class="card-body">
		                	<img src="{{Storage::disk('local')->url($data->featured_image)}}" class="profile-user-img img-responsive" alt="Selected Featured Image" id="output">
			                <div class="form-group">
		            ...
		            <div class="card card-default">
			            ...
			            <div class="card-body">
			                ...
			                <div class="form-group type-link">
			                    ...
			                    <input type="text" class="form-control" @if($data->delivery_type == 'Link') value="{{$data->delivery_entity}}" @endif name="delivery_link" placeholder="Enter Link">
			                </div>
		            ...
		            <div class="card card-default">
			            ...
			            <div class="card-body">
		                    ...
		                    <input type="text" name="meta_keyword" class="form-control" id="exampleInputEmail1" value="{{$data->meta_keyword}}" placeholder="Enter Meta Keywords">

			            	<label for="exampleInputEmail1">Meta Description</label>
			              	<textarea name="meta_desc" class="form-control" placeholder="Enter Meta Description">{{$data->meta_desc}}</textarea>
			            </div>
		                <!-- /.card-body -->
		            </div>
		            <!-- /.card -->
		            ...
		            <div class="card card-default">
			            ...
			            <div class="card-body">
			            	...
			            	<div class="input-group">
			                  ...
			                  <input type="text" name="price" value="{{$data->price}}" class="form-control" placeholder="Enter Current Price" required>
			                </div>
		                    ...
		                    <div class="input-group">
			                  ...
			                  <input type="text" name="special_price" value="{{$data->special_price}}" class="form-control" placeholder="Enter Special Price">
			                </div>
			            </div>
		                <!-- /.card-body -->
		            </div>
		            ...
		            <div class="card card-default">
		                ...
		                <div class="card-body">
		                  <div class="form-group">
		                    ...
		                    <input type="text" name="SKU" class="form-control" id="exampleInputEmail1" value="{{$data->SKU}}" placeholder="Enter SKU" required>
		                  </div>
		                  <div class="form-group">
