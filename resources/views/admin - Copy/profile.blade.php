		            ...
		            <div class="card-body box-profile">
		                <div class="text-center">
		                  	<form action="{{route('admin.image.update', Auth::guard('admin')->user()->id)}}" method="post" enctype="multipart/form-data">
					            ...
					            @else
					              	<label for="file" style="cursor: pointer; display: inline;"><img src="{{Vite::asset('resources/dist/img/avatar4.png')}}" class="profile-user-img img-responsive img-circle" alt="User profile picture" id="output"></label>
					            @endif
