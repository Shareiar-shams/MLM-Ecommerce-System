...
@endphp
@if( !empty($cookie))
<div class="js-lcc-modal js-lcc-modal-alert cookie-consent fixed bottom-0 inset-x-0 pb-2" style="display: none;"
            ...
            <div class="flex items-center justify-between flex-wrap">
                <div class="w-0 flex-1 items-center hidden md:inline">
                    <p class="ml-3 text-black cookie-consent__message">
                        {{ isset($cookie->text) ? $cookie->text : 'Your experience on this site will be improved by allowing cookies.'}}                        
                    </p>
                </div>
                <div class="lcc-modal__actions">
                    <button type="button" class="button3 js-lcc-accept">
                        @lang('cookie-consent::texts.alert_accept')
                    </button>
                    {{-- <button type="button" class="button3 js-lcc-essentials">
                        @lang('cookie-consent::texts.alert_essential_only')
                    </button>
                    <button type="button" class="button3 js-lcc-settings-toggle">
