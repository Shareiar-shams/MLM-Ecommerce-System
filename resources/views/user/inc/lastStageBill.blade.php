    ...
    <div class="card widget widget-featured-posts widget-order-summary p-4">
        ...
        <table class="table">
          <tbody>
            ...
            <tr id="shipping_cost_show" style="display: none;">
              	<td>Shipping:</td>
              	<td class="text-gray-dark" id="shippingMethodTex">$1.94</td>
            </tr>
        	<tr>
            ...
            <tr>
              	...
              	<td class="text-lg text-primary grand_total_set" id="cartTotal">&#2547; {{ number_format((float)\Cart::session(Session::getId())->getTotal(), 2, '.', '') }}</td>
            </tr>
          </tbody>
        </table>
    </div>
